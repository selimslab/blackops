...
class SleepSeconds(BaseModel):
    ...
    clear_follower_prices: float = 0.8
    ...
    refresh_open_orders: float = 0.4  # try every 200ms, 6 robots 1.2 secs
    cancel_open_orders: float = 0.05  # try every 200ms, 6 robots 1.2 secs
